<template>
  <div class="container">
    <div class="header">
      ...
      <div class="date">报告周期: 2023年10月16日 - 2023年10月22日</div>
    </div>
    ...
    <div class="filter-container">
      <div class="filter-group">
        ...
        <el-select v-model="filters.duration" class="filter-select" placeholder="请选择时长">
      ...
      <div class="filter-group">
        ...
        <el-select v-model="filters.area" class="filter-select" placeholder="请选择片区">
    ...
    <div class="section">
      ...
      <div class="chart-container">
        <div class="chart-box">
          <div class="chart-title">长时间未完成原因</div>
          <div class="chart-wrapper">
    ...
    <div class="footer">
      本报告由维修工单系统自动生成 | 生成时间: 2023-10-23 09:30:15
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      kpiData: [
        { label: '工单总数量', value: '158', trend: 'up', icon: 'fas fa-arrow-up', description: '比上周增加12%' },
        { label: '未完成工单数量', value: '7', trend: 'down', icon: 'fas fa-arrow-down', description: '比上周减少3个' },
        { label: '超时工单数量', value: '4', trend: 'up', icon: 'fas fa-arrow-up', description: '比上周增加1个' },
        { label: '平均完成时长', value: '4.2小时', trend: 'down', icon: 'fas fa-arrow-down', description: '比上周减少0.3小时' },
        { label: '一次性修复率', value: '98.1%', trend: '', icon: '', description: '与上周持平' }
      ],
      workerData: [
  ...
  methods: {
    ...
    initCharts() {
      ...
      // 注册Chart.js控制器
      window.Chart.controllers.doughnut = window.Chart.controllers.doughnut || window.Chart.defaults.doughnut
      window.Chart.controllers.pie = window.Chart.controllers.pie || window.Chart.defaults.pie
      window.Chart.controllers.bar = window.Chart.controllers.bar || window.Chart.defaults.bar
      window.Chart.controllers.line = window.Chart.controllers.line || window.Chart.defaults.line
      ...
      this.charts.delayReasonChart = new window.Chart(delayReasonCtx, {
        type: 'pie',
        data: {
